...
public class SimpleSorter implements Sort {
    ...
    public void sort(List<AbstractHit> hits){
        hits.sort((a,b)->{return Double.compare(score(b),score(a));});
    }
    ...
    public double score(AbstractHit hit){
        Map<AbstractTerm, AbstractPosting> termAbstractPostingMap=hit.getTermPostingMapping();
        AbstractPosting posting=termAbstractPostingMap.values().stream().findFirst().orElse(null);
